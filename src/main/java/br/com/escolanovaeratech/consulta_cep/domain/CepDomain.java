package br.com.escolanovaeratech.consulta_cep.domain;

public class CepDomain {

    // Fazer um molde para receber os dados da API ViaCep, com os mesmos nomes das propriedades que a API retorna
